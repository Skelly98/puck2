...
/**
 * @ast node
 * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\grammar\\ConstructorReference.ast:5
...
public class ConstructorReferenceAccess extends ClassInstanceExpr implements Cloneable {
  /**
   * @aspect Synthetics
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\MethodReference.jrag:446
   */
  private FunctionDescriptor targetDescriptor;
  /**
   * @aspect Synthetics
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\MethodReference.jrag:447
   */
   ...
   * @attribute syn
   * @aspect TargetType
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:207
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TargetType", declaredAt="D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:207")
  ...
  public TypeDecl Define_targetType(ASTNode _callerNode, ASTNode _childNode) {
    if (getAccessNoTransform() != null && _callerNode == getAccess()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:223
      {
          if (targetDescriptor.method.hasValue()) {
            return targetDescriptor.method.get().type();
          } else {
