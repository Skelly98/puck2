...
/**
 * @ast node
 * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java4\\grammar\\Java.ast:242
...
public abstract class ArithmeticExpr extends Binary implements Cloneable {
  ...
  public TypeDecl Define_targetType(ASTNode _callerNode, ASTNode _childNode) {
    if (getRightOperandNoTransform() != null && _callerNode == getRightOperand()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:72
      {
      ...
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:64
      {
          if (!getLeftOperand().isPolyExpression() && !getRightOperand().isPolyExpression()) {
            return type();
          } else {
  ...
  public boolean Define_numericContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getLeftOperandNoTransform() != null && _callerNode == getLeftOperand()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:283
      return true;
    }
    else if (getRightOperandNoTransform() != null && _callerNode == getRightOperand()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java8\\frontend\\TargetType.jrag:282
      return true;
    }
    else {
