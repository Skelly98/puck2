...
/**
 * @ast node
 * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\grammar\\Annotations.ast:12
...
public class ElementAnnotationValue extends ElementValue implements Cloneable {
   ...
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\PrettyPrint.jadd:86
   */
  ...
  @ASTNodeAnnotation.Source(aspect="Annotations", declaredAt="D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\Annotations.jrag:604")
  ...
  public boolean Define_mayUseAnnotationTarget(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (getAnnotationNoTransform() != null && _callerNode == getAnnotation()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\Annotations.jrag:167
      return true;
    }
    else {
