...
/**
 * @ast node
 * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\grammar\\GenericMethods.ast:22
...
public class ParClassInstanceExpr extends ClassInstanceExpr implements Cloneable {
   ...
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\GenericMethods.jrag:288
   */
  ...
  public NameType Define_nameType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\GenericMethods.jrag:245
  ...
  public SimpleSet<TypeDecl> Define_lookupType(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getTypeArgumentListNoTransform()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\GenericMethods.jrag:246
      int childIndex = _callerNode.getIndexOfChild(_childNode);
