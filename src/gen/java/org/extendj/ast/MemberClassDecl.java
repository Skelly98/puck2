...
/**
 * @ast node
 * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java4\\grammar\\Java.ast:189
...
public class MemberClassDecl extends MemberTypeDecl implements Cloneable {
   ...
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java4\\frontend\\PrettyPrint.jadd:454
   */
   ...
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\Generics.jrag:1490
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java5\\frontend\\Generics.jrag:1580
   */
  ...
  public boolean Define_isMemberType(ASTNode _callerNode, ASTNode _childNode) {
    if (getClassDeclNoTransform() != null && _callerNode == getClassDecl()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java4\\frontend\\TypeAnalysis.jrag:585
      return true;
    }
    else {
  ...
  public boolean Define_inStaticContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getClassDeclNoTransform() != null && _callerNode == getClassDecl()) {
      // @declaredat D:\\Informatique\\MASTER UPMC STL\\PSTL\\puck2\\extendj\\java4\\frontend\\TypeHierarchyCheck.jrag:219
      return false;
    }
    else {
